"""
Django settings for tgtest_182 project.
...
WSGI_APPLICATION = 'tgtest_182.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tgtest_182 API",
    "DESCRIPTION": "API documentation for tgtest_182 App",
    "VERSION": "v1",
}
